...
public static class RoomBuilder
{
    ...
    //  2  #....TT.....#   會議室長桌，座位 x4／x7
    //  5  #............   ← 東西通道，直接接辦公區
    //  7  ######DD#####   ← 公司大門（自動門 2 格寬），房間之間一律單格牆
    // 10  #TT.T..TT.T.#   門外自助區：販賣機／飲水機／咖啡吧台／影印機
    // 12  #.TT.TT.TT..#   訪客等候椅

    static readonly string[] West =
    {
        "#############",
        "#############",   // 北外牆 2 格（牆的美術本來就是「頂面＋牆面」兩格，同辦公區）
        "#....TT.....#",   // 會議室：長桌 x5-6，座位在 x4(面東) 與 x7(面西)，各三個
        "#....TT.....#",
        "#....TT.....#",
        "#............",   // ← 東西通道，(12,5) 直接接辦公區
        "#...........#",
        "######DD#####",   // ← 公司大門（自動門 2 格寬）。房間之間的牆一律【單格】
        "#.TT......TT#",   // 門外公共區：掛畫、書架靠牆
        "#...........#",
        "#TT.T..TT.T.#",   // 販賣機、飲水機、咖啡吧台、影印機
        "#..........T#",
        "#.TT.TT.TT..#",   // 訪客等候椅
        "#...........#",
        "#T.........T#",   // 角落盆栽
    ...
    {
        ("meet_a1@sit_right", 4, 2), ("meet_a2@sit_right", 4, 3), ("meet_a3@sit_right", 4, 4),
        ("meet_b1@sit_left", 7, 2), ("meet_b2@sit_left", 7, 3), ("meet_b3@sit_left", 7, 4),
        ("entrance@face_up", 6, 8),     // 大門【外】側：進出的人站這裡，也是開門的觸發點
        ("lobby_1", 4, 12), ("lobby_2", 7, 12),   // 訪客等候區
        ("vending_1", 2, 11), ("cooler_2", 4, 11),   // 販賣機／飲水機前
    };
