...
public static class RoomBuilder
{
    ...
    //
    // 玄關刻意放大成 11×7 的開放大廳——參考 LimeZu 官方 Office_Design_1 的入口廳，
    // 「別緻」來自等候區＋自助區的動線，不是家具數量。家具直接借用那張設計圖拆出來的
    // 元件（d1_* 前綴），不自己拼。
    //
    //     0123456789012
    //  2  #TT.TT..TTTT#   北牆一排：冷氣／掛畫／螢幕／書架
    //  7  D...........#   自動門那一列全通
    //  8  #TTT.T.TT..T#   南牆自助區：候客椅沿牆排，別擋住走道
    //  9  #####...#####   玄關與會議室之間，中央三格通行
    // 11  #....TT.....#   會議室長桌 x5-6；座位在 x4 與 x7
    static readonly string[] West =
    {
        "#############",
        "#############",
        "#TT.TT..TTTT#",   // 北牆：冷氣、彩色掛畫、圖表螢幕、書架
        "#...TT......#",   // 等候區的兩張圓椅
        "#T.........T#",   // 兩側盆栽
        "#............",   // ← 東西主走道，(12,5) 接辦公區
        "D...........#",   // ← 自動門（西牆 6~7 列）
        "D...........#",   // 自動門那一列全通
        "#TTT.T.TT..T#",   // 南牆自助區：影印機、候客椅×2、飲水機、販賣機、盆栽
        "#####...#####",   // 玄關／會議室之間，中央三格通行
        "#...........#",
        "#....TT.....#",   // 長桌 x5-6；座位在 x4(面東) 與 x7(面西)
        "#....TT.....#",
        "#....TT.....#",
        "#...........#",
        "#...........#",
    ...
    {
        ("meet_a1@sit_right", 4, 11), ("meet_a2@sit_right", 4, 12), ("meet_a3@sit_right", 4, 13),
        ("meet_b1@sit_left", 7, 11), ("meet_b2@sit_left", 7, 12), ("meet_b3@sit_left", 7, 13),
        ("entrance@face_right", 1, 6),  // 自動門內側：有人進出時站這裡（門的觸發點）
        ("lobby_1", 3, 4), ("lobby_2", 8, 4),   // 大廳等候區
        ("cooler_2", 5, 7),             // 西區飲水機前（站在它北邊那格）
    };
